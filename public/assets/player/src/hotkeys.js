...
var fs = require('fs');
vjs.plugin('hotkeys', function(options){
      var player = this;
      var pEl = player.el();
      var doc = document;
      var def_options = {
      ...
      var mouseScroll = function mouseScroll(event) {
        var activeEl_ = doc.activeElement;
        ...
        if (player.controls()) {
          if (alwaysCaptureHotkeys ||
              activeEl_ == pEl ||
              activeEl_ == pEl.querySelector('.vjs-tech') ||
              activeEl_ == pEl.querySelector('.iframeblocker') ||
              activeEl_ == pEl.querySelector('.vjs-control-bar') ||
              volumeHover) {
